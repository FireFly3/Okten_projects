...
for (const item of usersList) {
    ...
    catchPhrase.innerText = `${item.company.catchPhrase}`;

    let bs = document.createElement('div');
    bs.innerText = `${item.company.bs}`;


    geo.append(lat, lng);
    adress.append(street, suite, city, zipcode, geo);
    company.append(companyName, catchPhrase, bs);
    divArr.append(id, name, username, email, adress, phone, website, company);
