...
//
//         // console.log(e);
//         console.log(e.target.localName, e.target.classList.value, e.target.id, e.target.clientHeight,'*', e.target.clientWidth);
//     })
// }
...
//              e.stopPropagation()
//
//              blok.innerText = e.target.localName + e.target.classList.value + e.target.id + e.target.clientHeight + '*' + e.target.clientWidth;
...
chekbox1.setAttribute('type', 'checkbox');

let chekbox2 = document.createElement('input');
chekbox2.setAttribute('type', 'checkbox');

let chekbox3 = document.createElement('input');
chekbox3.setAttribute('type', 'checkbox');

document.body.append(chekbox1, chekbox2, chekbox3);
let foo = function (arr) {
    let newArr = arr
    chekbox1.onchange = function (e) {
        if (e.target.checked) {
